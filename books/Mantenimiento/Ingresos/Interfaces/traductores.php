<?php
/**
 * Pagina principal para agregar datos de traductores
 * @author @trbureiyan
 * @version 1.3
 */
?>
...
<body>
    <div class="container">
        <h2>Agregar Traductor</h2>
        <form name="frm_traductor" method="post" action="../Backend/ingreso_traductores.php"> 
            ...
            <div class="form-group">
                ...
                <input type="text" name="idioma_nativo" value="" id="" required>
            </div>
            <div class="form-group">
                <label for="idiomas_traduccion">Idiomas de Traduccion:</label>
                <input type="text" name="idiomas_traduccion" value="" id="" required>
            </div>
            <div class="form-group">
                <label for="certificaciones"># de Certificaciones:</label>
                <input type="number" name="certificaciones" value="" id="" required>
            </div>
