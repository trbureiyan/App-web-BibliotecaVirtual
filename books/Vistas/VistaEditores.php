...
/**
 * Esta es la página principal de las vistas de editores.
 * Proporciona un menú de opciones para elegir que columnas ver en la tabla de editores para luego mostrarla.
 * @author @trbureiyan
 * @version 1.0
 */
...
<header>
    <nav>
		<div class="Encabezado">
			<a class="Titulo">Vista de Editores</a>
		</div>
	</nav>
</header>
...
<body>
	<div class="container">
		...
		<form action=" " method="POST">
			<select name="columnas" class="browser-default" required>
				...
				<option value="nombre_editorial">Nombre de la editorial</option>
				<option value="pais">Pais</option>
				<option value="Nombre, Apellidos, nombre_editorial, pais">Todas</option>
			</select>
    ...
    if (isset($_POST['columnas'])) {
        ...
        if (empty($columnas)) {
            ...
            $query = "SELECT " . implode(", ", $columnasArray) . " FROM editores ORDER BY ID_editores ASC";
